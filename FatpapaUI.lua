...
--player frame--
    ...
    PlayerName:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12, "OUTLINE, THICKOUTLINEOUTLINE");
    ...
    PlayerFrameHealthBarTextLeft:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12,
        "OUTLINE, THICKOUTLINE");


    PlayerFrameHealthBarTextRight:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12,
        "OUTLINE, THICKOUTLINE");
...
--	PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.ManaBarArea:Hide(); --not this
	...
	PlayerFrameHealthBarText:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12,
        "OUTLINE, THICKOUTLINE");
	--PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.ManaBarMask:SetAlpha(0);
	
	
	--PlayerFrameManaBar:SetAlpha(); 
	PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.ManaBarArea:SetAlpha(0);
	PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.ManaBarArea.Show = function() end
	--target frame--
	...
	TargetFrame.TargetFrameContent.TargetFrameContentMain.Name:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 11, "OUTLINE, THICKOUTLINE");
	...
	TargetFrame.TargetFrameContent.TargetFrameContentMain.HealthBar.LeftText:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12,
        "OUTLINE, THICKOUTLINE");
   	TargetFrame.TargetFrameContent.TargetFrameContentMain.HealthBar.RightText:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 12,
        "OUTLINE, THICKOUTLINE");
	TargetFrame.TargetFrameContent.TargetFrameContentMain.ManaBar.LeftText:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 9,
        "OUTLINE, THICKOUTLINE");
   	TargetFrame.TargetFrameContent.TargetFrameContentMain.ManaBar.RightText:SetFont("Interface\\AddOns\\Details\\fonts\\Accidental Presidency.ttf", 9,
        "OUTLINE, THICKOUTLINE");
